...
//  mySerial.begin(57600);
  mySerial.begin(57600,SERIAL_8N1,33,32);
  Mav_Request_Data();
}
        ...
        case MAVLINK_MSG_ID_ATTITUDE:  // #1: SYS_STATUS
          {
            ...
            Serial.print("roll :"); Serial.print(attitude.roll);  Serial.println();
          }
          break;
        ...
        case MAVLINK_MSG_ID_LOCAL_POSITION_NED:  // #22: PARAM_VALUE
          {
            ...
            Serial.print("x :"); Serial.print(local_pos.x);  Serial.println();
            Serial.print("x :"); Serial.print(local_pos.y);  Serial.println();
            Serial.print("x :"); Serial.print(local_pos.vx);  Serial.println();
          }
          break;
